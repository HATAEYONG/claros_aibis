...
# 기존 모델 import - Django 앱 레지스트리를 사용하여 모델 충돌 방지
# models/ 디렉토리와 models.py가 공존하므로, apps.get_model() 사용

ERPSalesYearPlan = apps.get_model('erp_sync', 'ERPSalesYearPlan')
ERPShipmentPlan = apps.get_model('erp_sync', 'ERPShipmentPlan')
ERPShipmentPlanItem = apps.get_model('erp_sync', 'ERPShipmentPlanItem')
ERPDeliveryHistory = apps.get_model('erp_sync', 'ERPDeliveryHistory')
ERPBOM = apps.get_model('erp_sync', 'ERPBOM')
ERPMRP = apps.get_model('erp_sync', 'ERPMRP')
ERPMRPMaterial = apps.get_model('erp_sync', 'ERPMRPMaterial')
ERPProductionResult = apps.get_model('erp_sync', 'ERPProductionResult')
ERPMESData = apps.get_model('erp_sync', 'ERPMESData')
ERPQualityItem = apps.get_model('erp_sync', 'ERPQualityItem')
ERPShipmentInspection = apps.get_model('erp_sync', 'ERPShipmentInspection')
ERPShipmentDefect = apps.get_model('erp_sync', 'ERPShipmentDefect')
ERPSupplier = apps.get_model('erp_sync', 'ERPSupplier')
ERPSupplierEvaluation = apps.get_model('erp_sync', 'ERPSupplierEvaluation')
ERPSPC = apps.get_model('erp_sync', 'ERPSPC')
ERPBarcodeDelivery = apps.get_model('erp_sync', 'ERPBarcodeDelivery')
ERPMaterialPlan = apps.get_model('erp_sync', 'ERPMaterialPlan')
ERPInventoryCheck = apps.get_model('erp_sync', 'ERPInventoryCheck')
ERPLocation = apps.get_model('erp_sync', 'ERPLocation')
ERPLocationStock = apps.get_model('erp_sync', 'ERPLocationStock')
ERPWorkInProcess = apps.get_model('erp_sync', 'ERPWorkInProcess')
ERPProductLedger = apps.get_model('erp_sync', 'ERPProductLedger')
ERPAccountLedger = apps.get_model('erp_sync', 'ERPAccountLedger')
ERPSyncLog = apps.get_model('erp_sync', 'ERPSyncLog')
ERPSyncConfig = apps.get_model('erp_sync', 'ERPSyncConfig')

# 신규 매핑 관리 모델 import (앱 레지스트리 사용)
try:
    ERPSource = apps.get_model('erp_sync', 'ERPSource')
    ERPTableDefinition = apps.get_model('erp_sync', 'ERPTableDefinition')
    ERPFieldDefinition = apps.get_model('erp_sync', 'ERPFieldDefinition')
    ERPTargetModel = apps.get_model('erp_sync', 'ERPTargetModel')
    ERPTargetField = apps.get_model('erp_sync', 'ERPTargetField')
    ERPTableMapping = apps.get_model('erp_sync', 'ERPTableMapping')
    ERPFieldMapping = apps.get_model('erp_sync', 'ERPFieldMapping')
except LookupError:
    # 모델이 없는 경우
    ERPSource = None
    ERPTableDefinition = None
    ERPFieldDefinition = None
    ERPTargetModel = None
    ERPTargetField = None
    ERPTableMapping = None
