...
class ERPTableDefinitionDetailSerializer(ERPTableDefinitionSerializer):
    ...
    table_mappings = serializers.SerializerMethodField()

    class Meta(ERPTableDefinitionSerializer.Meta):
        fields = ERPTableDefinitionSerializer.Meta.fields + ['field_definitions', 'table_mappings']
    ...
    def get_table_mappings(self, obj):
