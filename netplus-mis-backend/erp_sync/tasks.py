...
@shared_task(
    name='netplus_mis.erp_sync.tasks.urgent_sync',
    queue='high',
    priority=9,
    max_retries=3,
...
@shared_task(
    name='netplus_mis.erp_sync.tasks.sync_realtime_task',
    queue='medium',
    priority=5,
    max_retries=2
)
...
@shared_task(
    name='netplus_mis.erp_sync.tasks.sync_hourly_task',
    queue='medium',
    priority=5,
    max_retries=2
)
...
@shared_task(
    name='netplus_mis.erp_sync.tasks.batch_sync',
    queue='low',
    priority=2,
    max_retries=1
)
...
@shared_task(
    name='netplus_mis.erp_sync.tasks.full_sync',
    queue='low',
    priority=1,
    max_retries=1
)
...
@shared_task(
    name='netplus_mis.erp_sync.tasks.verify_sync',
    queue='medium',
    priority=4,
    max_retries=2
)
