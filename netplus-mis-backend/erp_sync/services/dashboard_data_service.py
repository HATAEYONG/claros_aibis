...
from erp_sync.models.erp_source import ERPSource, ERPTableDefinition
from erp_sync.models.mis_target import ERPTargetModel
from erp_sync.models.mapping import ERPTableMapping, ERPFieldMapping
...
class DataSyncService:
    ...
    def fetch_from_erp(erp_source, table_name, where_clause=None, limit=None, order_by=None):
        ...
        try:
            ...
            logger.error(f"[DataSyncService] Error fetching from ERP: {str(e)}", exc_info=True)
            return []
        ...
        try:
            ...
            if erp_source:
                try:
                    ...
                    logger.warning(f"[Dashboard] ERP query failed, using fallback data: {str(e)}")
