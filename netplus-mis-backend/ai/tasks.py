...
@shared_task(
    name='netplus_mis.ai.tasks.high_priority_prediction',
    queue='high',
    priority=9,
    max_retries=3,
...
@shared_task(
    name='netplus_mis.ai.tasks.emergency_alert',
    queue='high',
    priority=10,
    max_retries=5
)
...
@shared_task(
    name='netplus_mis.ai.tasks.calculate_kpi_task',
    queue='medium',
    priority=5,
    max_retries=2
)
...
@shared_task(
    name='netplus_mis.ai.tasks.run_predictions_task',
    queue='medium',
    priority=5,
    max_retries=2
)
...
@shared_task(
    name='netplus_mis.ai.tasks.batch_prediction',
    queue='medium',
    priority=4,
    max_retries=2
)
...
@shared_task(
    name='netplus_mis.ai.tasks.low_priority_model_training',
    queue='low',
    priority=2,
    max_retries=1
)
...
@shared_task(
    name='netplus_mis.ai.tasks.cleanup_old_data_task',
    queue='low',
    priority=1,
    max_retries=1
)
...
@shared_task(
    name='netplus_mis.ai.tasks.generate_report_task',
    queue='low',
    priority=3,
    max_retries=2
)
...
@shared_task(
    name='netplus_mis.ai.tasks.health_check',
    queue='high',
    priority=8
)
