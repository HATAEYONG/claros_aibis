...
@shared_task(
    name='netplus_mis.utils.tasks.health_check_task',
    queue='high',
    priority=8
)
...
@shared_task(
    name='netplus_mis.utils.tasks.cleanup_logs_task',
    queue='medium',
    priority=4,
    max_retries=1
)
...
@shared_task(
    name='netplus_mis.utils.tasks.cleanup_cache_task',
    queue='medium',
    priority=3
)
...
@shared_task(
    name='netplus_mis.utils.tasks.check_disk_space_task',
    queue='medium',
    priority=5
)
...
@shared_task(
    name='netplus_mis.utils.tasks.generate_report_task',
    queue='low',
    priority=2,
    max_retries=1
)
...
@shared_task(
    name='netplus_mis.utils.tasks.archive_data_task',
    queue='low',
    priority=1,
    max_retries=1
)
...
@shared_task(
    name='netplus_mis.utils.tasks.update_metrics_task',
    queue='medium',
    priority=5
)
