...
import ABCCost from '@/components/dashboard/ABCCost';
import AdvancedVisualization from '@/components/dashboard/AdvancedVisualization';
...
import DataExportDemo from '@/components/dashboard/DataExportDemo';
import DesignCost from '@/components/dashboard/DesignCost';
...
import FourM2EStrategy from '@/components/dashboard/FourM2EStrategy';
import KPIManagement from '@/components/dashboard/KPIManagement';
import LocalAnalysis from '@/components/dashboard/LocalAnalysis';
...
import OutsourcingCost from '@/components/dashboard/OutsourcingCost';
import PerformanceOptimizationDemo from '@/components/dashboard/PerformanceOptimization';
...
import SalesCost from '@/components/dashboard/SalesCost';
import ScenarioAnalysis from '@/components/dashboard/ScenarioAnalysis';
import StandardCost from '@/components/dashboard/StandardCost';
import Standards from '@/components/dashboard/Standards';
import YHDatabaseConnection from '@/components/dashboard/YHDatabaseConnection';
import { ERPSyncConfiguration } from '@/components/erp/ERPSyncConfiguration';
import MappingManagement from '@/components/erp/MappingManagement';
...
const App: React.FC = () => {
  ...
  const menuItems = [
    ...
    { id: 'standards', icon: DatabaseIcon, label: '기준정보' },
    ...
    { id: 'fourM2EStrategy', icon: ActivityIcon, label: '4M2E 전략' },
    ...
    { id: 'predictionManagement', icon: TrendUpIcon, label: '예측 관리' },
            ...
            <div className="flex h-screen bg-gray-100 dark:bg-gray-900">
              ...
              <aside className={`${sidebarOpen ? 'w-64' : 'w-0'} bg-blue-900 text-white transition-all duration-300 overflow-hidden flex-shrink-0 flex flex-col`}>
                <div className="p-4 flex-shrink-0">
                  <h1 className="text-xl font-bold mb-4">AI & BI 지능형 시스템</h1>
                </div>
                  ...
                  <nav className="space-y-1">
                    {menuItems.map(item => (
                      <div key={item.id}>
                        ...
                        {item.children && (
                          <div id={`submenu-${item.id}`} className="hidden ml-6 mt-1 space-y-1">
